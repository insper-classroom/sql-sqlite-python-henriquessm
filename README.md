...
[![Open in Visual Studio Code](https://classroom.github.com/assets/open-in-vscode-718a45dd9cf7e7f842a935f5ebbe5719a5e09af4491e668f4dbf3b35d5cca122.svg)](https://classroom.github.com/online_ide?assignment_repo_id=11573637&assignment_repo_type=AssignmentRepo)
# ProjÁgil - 2023
...
1. **Jogos da plataforma Xbox One**:
   ...
   - **Query**:
     ...
     ```
   - **Resultado**
    ![Alt text](<imagens/Screenshot 2023-08-18 103509.png>)
...
2. **Jogos de Ação após 2010**:
   ...
   - **Query**:
     ...
     ```
   - **Resultado**
    ![Alt text](<imagens/Screenshot 2023-08-18 103913.png>)
...
6. **Jogos de RPG ou Estratégia lançados após 2005**:
   ...
   - **Query**:
     ```sql
      SELECT * FROM vgsales_pbi
      WHERE year > 2005.0 and (genre == 'Role-Playing' OR genre == 'Strategy');
     ```
   - **Resultado**
